 ...
 * из воркера (`apps/worker/src/processor.ts`) вне Nest-контекста.
 *
 * Логируются: отказы (проверка файла, параметры), успешные конвертации
 * и ошибки конвертации. Набор сужен вместе с переходом на конвертацию
 * документов в PDF: функции для SSRF и XML-атак удалены вместе с путями,
